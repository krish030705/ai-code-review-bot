    ...
    <div className="min-h-screen flex bg-slate-950">
      ...
      <aside className="w-60 bg-slate-900 border-r border-white/10 flex flex-col">
        <div className="px-5 py-5 flex items-center gap-2 border-b border-white/10">
          ...
          <span className="text-white font-semibold text-sm">CodeReview AI</span>
        </div>
        ...
        <div className="px-3 py-4 border-t border-white/10">
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:bg-red-500/10 hover:text-red-400 transition"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
